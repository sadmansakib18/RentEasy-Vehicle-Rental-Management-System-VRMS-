...
<div class="auth-body" style="min-height: 100vh; padding: 40px 20px; display: flex; align-items: center; justify-content: center;">
    <div class="auth-container w-max-480">
        ...
        <?php if (!$allowRegistration) { ?>
            <div style="background-color: #fee2e2; color: #991b1b; padding: 15px; border-radius: 6px; margin-bottom: 20px; font-size: 14px; text-align: center;">
                <strong>Public Registrations Disabled</strong><br>
                New user sign-ups are currently closed by the administration. For assistance, please email <a href="mailto:<?php echo htmlspecialchars($contactEmail); ?>" style="color: #991b1b; font-weight: bold;"><?php echo htmlspecialchars($contactEmail); ?></a>.
            </div>
            <div class="auth-footer">
                <a href="index.php?controller=auth&action=login" class="btn btn-primary btn-full">Return to Sign In</a>
            </div>
        <?php } else { ?>
